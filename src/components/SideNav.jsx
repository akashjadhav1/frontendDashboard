  ...
  return (
    ...
    >
      <div className="flex justify-around pt-3">
        <div>
          <img
            src="https://static.vecteezy.com/system/resources/previews/011/423/495/original/ih-logo-i-h-design-white-ih-letter-ih-letter-logo-design-initial-letter-ih-linked-circle-uppercase-monogram-logo-vector.jpg"
            alt="Logo"
            className="rounded w-[35px] mt-2"
          />
        </div>
        ...
        <div>
          <img
            src="https://png.pngitem.com/pimgs/s/79-791921_male-profile-round-circle-users-profile-round-icon.png"
            className="w-[35px] mt-2.5"
            alt="Profile"
          />
        </div>
        <div>
          <button
            className="md:hidden block text-xl ml-2"
            onClick={handleClose}
          >
            <span>&times;</span>
          </button>
      ...
      <div className="mt-6">
        <div className=" flex border  hover:bg-gray-300 cursor-pointer rounded mt-3 px-1">
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-vector-pen mt-1"
            viewBox="0 0 16 16"
          >
            <path
              fillRule="evenodd"
        ...
        <div className="flex border px-1 hover:bg-gray-300 cursor-pointer rounded mt-2">
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-megaphone mt-1"
            viewBox="0 0 16 16"
          >
        ...
        <div className="flex ">
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-file-earmark-plus mt-4 mx-1 cursor-pointer"
            viewBox="0 0 16 16"
          >
      ...
      <div className="flex px-1 mt-10 hover:bg-gray-300 cursor-pointer rounded border">
        <svg
          ...
          height="16"
          fill="currentColor"
          className="bi bi-person-plus mt-1"
          viewBox="0 0 16 16"
        >
      ...
      <div className="flex border px-1 mt-1 hover:bg-gray-300 cursor-pointer rounded">
        <svg
          ...
          height="16"
          fill="currentColor"
          className="bi bi-question-circle mt-1"
          viewBox="0 0 16 16"
        >
