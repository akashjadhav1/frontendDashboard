...
function Table({ sort,searchInput }) {
  ...
  return (
    ...
    <table className="table-auto">
        ...
        <tbody>
          {(searchInput.length>0?filteredData: data[0].brands).map((brand, index) => (
            <tr key={index} className="border">
              ...
              <td className="border">
              <div className={`md:text-sm text-xs border-[1.5px] md:mx-3 text-center p-0.5  border-black rounded ${
          ...
          <tr className="border text-sm">
            ...
            <td className="border px-1">
              <span className="font-bold">{searchInput.length > 0 ? filteredData.length : data[0].brands.length}</span> Count
            </td>
      ...
      <div className="mt-4 p-2 shadow  flex justify-center border ">
        ...
        <div className="flex border mx-3 shadow shadow-md text-sm p-1 rounded hover:bg-gray-200">
          <svg
            ...
            height="16"
            fill="currentColor"
            class="bi bi-archive mt-0.5 cursor-pointer"
            viewBox="0 0 16 16"
          >
        ...
        <div className="flex border mx-3 shadow shadow-md text-sm p-1 rounded text-red-500 hover:bg-gray-200">
          <svg
            ...
            height="16"
            fill="currentColor"
            class="bi bi-trash3 mt-0.5 cursor-pointer"
            viewBox="0 0 16 16"
          >
